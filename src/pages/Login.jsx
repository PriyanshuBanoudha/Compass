          ...
          {isRegisteringStudent ? (
            <div className="space-y-4">
              <div>
                ...
                <input 
                  type="text" 
                  className="w-full px-4 py-2.5  border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-xl  text-sm transition-all outline-none placeholder-slate-600" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold  uppercase tracking-wider mb-2">Roll Number (Unique ID)</label>
                  <input 
                    type="text" 
                    className="w-full px-4 py-2.5  border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-xl  text-sm transition-all outline-none placeholder-slate-600" 
                    placeholder="e.g. BE24XYZ"
                    value={rollNumber} 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input 
                    type="number" 
                    className="w-full px-4 py-2.5 bg-slate-955 border border-slate-800 focus:border-indigo-505 focus:ring-1 focus:ring-indigo-550 rounded-xl  text-sm transition-all outline-none placeholder-slate-605" 
                    placeholder="1"
                    value={semester} 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-semibold text-blackuppercase tracking-wider mb-2">Phone Number</label>
                  <input 
                    type="tel" 
                    className="w-full px-4 py-2.5  border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-xl  text-sm transition-all outline-none"  
                    value={phone} 
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-450 uppercase tracking-wider mb-2">Alternate Number</label>
                  <input 
                    type="tel" 
                    className="w-full px-4 py-2.5  border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-xl  text-sm transition-all outline-none placeholder-slate-600"  
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  type="email" 
                  className="w-full px-4 py-2.5 bg-slate-955 border border-slate-800 focus:border-indigo-505 focus:ring-1 focus:ring-indigo-505 rounded-xl  text-sm transition-all outline-none placeholder-slate-505" 
                  placeholder="e.g. john@university.edu"
                  value={email} 
                  onChange={(e) => setEmail(e.target.value)} 
                  required 
